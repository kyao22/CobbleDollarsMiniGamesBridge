...
public abstract class CoinEconomyHooks {
    ...
    private Iterable<?> inventoryStacks(class_3222 player) {
        ...
        try {
            ...
            java.util.ArrayList<Object> stacks = new java.util.ArrayList<>();
    ...
    private boolean isArcadeCoin(Object stack) {
        ...
        try {
            ...
            return String.valueOf(identifier).equals("cobblemonminigames:arcade_coin");
        } catch (ReflectiveOperationException exception) {
            return false;
        }
    }
